...
[source,json]
----
default-scenarios = ["upToDateBuild"]
upToDateBuild {
    tasks = ["assemble"]
}
nonAbiChange {
...
* Résultats en CSV et en HTML
* TODO screenshot + link to results
...
* TODO screenshot + link to flame graphs etc...

=== Elements de la performance Gradle
image::gradle/bg-2.png[background, size=cover]

* Parallèlisme
* Resolution de dépendances
* Gestion de la mémoire


// =====================================================================================================================
// TODO Choisir le chapitre - sont dans build logic aussi
...
* Les Build Scans montrent la pression mémoire image:build-scan-link.svg[link=https://scans.gradle.com/s/rcqiowuogd2xu/performance/build#garbage-collection]
